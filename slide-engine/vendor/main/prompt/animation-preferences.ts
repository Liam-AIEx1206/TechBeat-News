...
export function formatAnimationPreferencesForPageWriting(
  ...
  return [
    ...
    '- Animation is downstream only: follow the already-decided slide form, content enrichment, source grounding, and layout density. Never reduce, skip, or reshape warranted content enrichment to satisfy an animation preference.',
