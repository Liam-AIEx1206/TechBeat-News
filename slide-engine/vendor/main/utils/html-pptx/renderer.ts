...
export interface HtmlPageToPptxSlideOptions {
  ...
  settleMs: number
  /**
   * Tuong thich chu ky renderer.ts goc (Electron): caller truyen ham cho
   * print-ready dua tren BrowserWindow. Ban Playwright tu nghe console message
   * cung prefix nen tham so nay duoc nhan nhung khong dung.
   */
  waitForPrintReadySignal?: unknown
}
