  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "center", marginBottom: 12, filter: dragging ? "drop-shadow(0 0 12px rgba(249,115,22,0.6))" : "none", transition: "filter 0.3s", color: "var(--accent)" }}>
